...
```json
"com.actionfit.connectivity": "https://github.com/ActionFit-Editor/Connectivity.git#1.0.5"
```
...
Unity Test Framework의 EditMode에서 `com.actionfit.connectivity.Editor.Tests`를 실행하면 상태 전이, OS offline 조기 판정, probe 결과, 재시도, 복구 대기, Pause/Resume, fallback 순서와 HTTPS observation 파싱을 검증할 수 있습니다.
